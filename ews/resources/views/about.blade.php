        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center"> <br>
                ...
                <p>
                    ...
                    apakah ada tanda-tanda gempa bumi yang mungkin akan terjadi.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="team-member d-flex flex-column justify-content-center align-items-center">
                <img src="../assets/img/marioo.jpg" alt="Team Member">
                <h4>Mario Achmad Rasyidin</h4>
                <p>50421778</p>
        ...
        <div class="col-lg-4">
            <div class="team-member d-flex flex-column justify-content-center align-items-center">
                <img src="../assets/img/Lagsyaakrama.png" alt="Team Member">
                <h4>Lagsya Akrama</h4>
                <p>50420663</p>
                <p>Universitas Gunadarma</p>
            </div>
        ...
        <div class="col-lg-4">
            <div class="team-member d-flex flex-column justify-content-center align-items-center">
                <img src="../assets/img/ShintaMeidytaPutri.png" alt="Team Member">
                <h4>Shinta Meidyta Putri</h4>
                <p>51421418</p>
                <p>Universitas Gunadarma</p>
            </div>
        </div> 
